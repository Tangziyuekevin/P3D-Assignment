...
public class camerarotate : MonoBehaviour {
    ...
    void LateUpdate()
    {
        current_rotation_X += Input.GetAxis("Mouse Y") * X_rotateSpeed;//获取鼠标滑动
        ...
        transform.localEulerAngles = new Vector3(-current_rotation_X, current_rotation_Y, 0f);//根据鼠标滑动旋转摄像机
